...
public class AlimentsAdd extends ListActivity  implements android.view.View.OnClickListener{
    ...
    public void onClick(View view) {
        if (view== findViewById(R.id.btnAdd)){
            ...
            if(alimentsList.size()!=0) {
                ...
                ListAdapter adapter = new SimpleAdapter( AlimentsAdd.this,alimentsList, R.layout.view_aliments_entry, new String[] { "id","name"}, new int[] {R.id.aliments_Id, R.id.aliments_name});
